return {
    {
        ...
        init = function()
            ...
            vim.keymap.set("n", "<C-S>", ":MoltenShowOutput<CR>", { silent=true, desc = "show output"})
            vim.keymap.set("n", "<C-H>", ":MoltenHideOutput<CR>", { silent = true, desc = "hide output" })
            ...
            vim.keymap.set("n", "<leader>mim", ":MoltenImagePopup<CR>", { desc = "interrupt currently running cell" })
